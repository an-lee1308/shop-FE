  ...
  useEffect(() => {
    async function getProduct() {
      ...
      var dataProduct = await CallApi({
        url: `https://radiant-wave-89582.herokuapp.com/api/detailproducts/${id}`,
        method: "get",
      });
      var dataProductRecommend = await CallApi({
        url: `https://radiant-wave-89582.herokuapp.com/api/products/Laptop?type=1`,
        method: "get",
      });
      var dataProductPk = await CallApi({
        url: `https://radiant-wave-89582.herokuapp.com/api/products/PK`,
        method: "get",
      });
