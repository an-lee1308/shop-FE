...
function ReplyItem(props) {
  ...
  function onSendComment() {
    ...
    axiosClient({
      url: `https://radiant-wave-89582.herokuapp.com/api/detailproducts/${id}/reply/${idComment}`,
      method: "post",
      data: {
        content: content,
      },
...
function Comment(props) {
  ...
  useEffect(() => {
    axiosClient({
      url: `https://radiant-wave-89582.herokuapp.com/api/detailproducts/${id}/comment?page=${page}`,
      method: "get",
    }).then((data) => {
      setlistComment(data);
    });
  ...
  function onSendComment() {
    if (!user) {
      ...
      axiosClient({
        url: `https://radiant-wave-89582.herokuapp.com/api/detailproducts/${id}/comment`,
        method: "post",
        data: {
