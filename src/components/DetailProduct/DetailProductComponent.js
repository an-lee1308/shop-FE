          ...
          <div className="css-14">
            ...
            <div className="css-70">
              <div className="css-71">
                - CPU: Intel Core i7-10510U <br></br>- Màn hình: 14" IPS (1920 x
                1080) <br></br>- RAM: 1 x 8GB DDR4 2666MHz <br></br>- Đồ họa:
                NVIDIA GeForce MX250 2GB GDDR5 / Intel UHD Graphics <br></br>-
                Lưu trữ: 512GB SSD M.2 NVMe / <br></br>- Hệ điều hành: Windows
                10 Home SL 64-bit <br></br>- Pin: 4 cell 50 Wh Pin liền{" "}
                <br></br>- Khối lượng: 1.2 kg
              </div>
            </div>
          </div>
          <div className="css-15">
            <div className="detail-product">
              <div className="css-6 css-1002">
                ...
                <h6 className="css-8">
                  Thương hiệu <span className="css-12">MSI</span>{" "}
              ...
              <div className="css-20">
                ...
                <ul className="css-23">
                  <li className="css-24">
                    [Super Sale] Giảm 10% tất cả sản phẩm đến 2.5 triệu* cho
                    khách hàng đăng kí nhận mã vào 28/10-29/10. Số lượng giới
                    hạn <span className="css-1003">Xem chi tiết!</span>
                  </li>
                  <li className="css-24">
                    Nhập mã PHONGVU200 giảm thêm 5% tối đa 200.000đ khi thanh
                    toán qua VNPAY-QR{" "}
